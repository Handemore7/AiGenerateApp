  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch('https://dall-e-app-a1zr.onrender.com/api/v1/dallE', {
          method: 'POST',
          headers: {
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>Create through a collection of images created by an AI and share them with the community</p>
      </div>
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          <FormField 
            ...
            type='text'
            name='name'
            placeholder='Write your name to remember you :)'
            value={form.name}
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>
            Once you have created the image, if you want, youe can share it with other in the community 
          </p>
